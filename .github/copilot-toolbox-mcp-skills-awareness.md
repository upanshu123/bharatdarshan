...
_Generated: 2026-09-12T10:57:39.337Z_
...
Workspace `mcp.json` _(folder: bharatdarshan)_

- **c:\Users\Upanshu Gautam\OneDrive\Desktop\bharatdarshan\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Upanshu Gautam\AppData\Roaming\Code\User\mcp.json** — _File missing_
